    ...
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <div className="flex-1 relative">
        <input
          ...
          placeholder="Search for actions, objects, or scenes..."
          className="w-full px-4 py-3 bg-foreground/5 border border-foreground/10 rounded-xl text-foreground placeholder-foreground/40 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
